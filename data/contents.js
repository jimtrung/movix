    ...
    <div class="main-wrapper">
      <div class="main-container">
        <div class="content">
          ...
          <div class="step-logo-container">
            <i class="computer-icon fa-solid fa-computer"></i>
            <i class="laptop-icon fa-solid fa-laptop"></i>
            <i class="fa-solid fa-desktop"></i>
          </div>
          <h1>Hoàn thành việc cài đặt tài khoản của bạn</h1>
          <div>
            <span class="yapping">
              Movix được cá nhân hóa cho riêng bạn. Tạo mật khẩu để xem Movix trên bất kỳ thiết bị nào, vào bất cứ lúc
              nào.
            </span>
          </div>
        </div>
    ...
    <div class="main-wrapper">
      <div class="main-container">
        <div class="content">
          ...
          <div>
            <span class="yapping yapping-1">Chỉ cần vài bước nữa là bạn sẽ hoàn tất!</span>
      ...
      <div class="main-container">
        <div class="content">
          ...
          <div>
            ...
            <div class="yapping">
              <i class="fa-solid fa-check"></i>
              <span>Mọi thứ trên Movix chỉ với mức giá thấp.</span>
            </div>
            <div class="yapping">
              <i class="fa-solid fa-check"></i>
          ...
          <div class="pricing-container">
            <div class="pack-container">
              <div class="pack-header mobile">
                ...
                <span class="picked-icon-container">
                  <i class="invisible picked-icon fa-solid fa-circle-check"></i>
                </span>
              </div>
              <div class="pack-description">
                <div class="desc">
                  <span class="col">Giá hàng tháng</span>
                  <span class="col-detail">70.000 đ</span>
                </div>
                <hr>
                <div class="desc">
                  <span class="col">Chất lượng hình ảnh và âm</span>
                  <span class="col-detail">Khá</span>
                </div>
                <hr>
                <div class="desc">
                  <span class="col">Độ phân giải</span>
                  <span class="col-detail">480p</span>
                </div>
                <hr>
                <div class="desc">
                  <span class="col">Thiết bị hỗ trợ</span>
                  <span class="col-detail">Điện thoại di động, máy tính bảng</span>
                </div>
                <hr>
                <div class="desc">
                  <span class="col">Số lượng thiết bị có thể xem cùng 1 lúc</span>
                  <span class="col-detail">1</span>
                </div>
                <hr>
                <div class="desc">
            ...
            <div class="pack-container">
              ...
              <div class="pack-description">
                <div class="desc">
                  <span class="col">Giá hàng tháng</span>
                  <span class="col-detail">108.000 đ</span>
                </div>
                <hr>
                <div class="desc">
                  <span class="col">Chất lượng hình ảnh và âm</span>
                  <span class="col-detail">Tốt</span>
                </div>
                <hr>
                <div class="desc">
                  <span class="col">Độ phân giải</span>
                  <span class="col-detail">720p (HD)</span>
                </div>
                <hr>
                <div class="desc">
                  <span class="col">Thiết bị hỗ trợ</span>
                  <span class="col-detail">TV, máy tính, điện thoại di động, máy tính bảng</span>
                </div>
                <hr>
                <div class="desc">
                  <span class="col">Số lượng thiết bị có thể xem cùng 1 lúc</span>
            ...
            <div class="pack-container">
              ...
              <div class="pack-description">
                <div class="desc">
                  <span class="col">Giá hàng tháng</span>
                  <span class="col-detail">220.000 đ</span>
                </div>
                <hr>
                <div class="desc">
                  <span class="col">Chất lượng hình ảnh và âm</span>
                  <span class="col-detail">Tuyệt vời</span>
                </div>
                <hr>
                <div class="desc">
                  <span class="col">Độ phân giải</span>
                  <span class="col-detail">1080p (Full HD)</span>
                </div>
                <hr>
                <div class="desc">
                  <span class="col">Thiết bị hỗ trợ</span>
            ...
            <div class="pack-container">
              <div class="pack-header luxury">
                ...
                <span class="picked-icon-container">
                  <i class="picked-icon fa-solid fa-circle-check"></i>
                </span>
              </div>
              <div class="pack-description">
                <div class="desc">
                  <span class="col">Giá hàng tháng</span>
                  <span class="col-detail">260.000 đ</span>
                </div>
                <hr>
                <div class="desc">
                  <span class="col">Chất lượng hình ảnh và âm</span>
                  <span class="col-detail">Tốt nhất</span>
                </div>
                <hr>
                <div class="desc">
                  <span class="col">Độ phân giải</span>
                  <span class="col-detail">4K (Ultra HDR) + HDR</span>
                </div>
                <hr>
                <div class="desc">
                  <span class="col">Âm thanh không gian (Âm thanh chân thực)</span>
                  <span class="col-detail">Đã bao gồm</span>
                </div>
                <hr>
                <div class="desc">
                  <span class="col">Thiết bị hỗ trợ</span>
                ...
                <div class="desc">
                  <span class="col">Số lượng thiết bị có thể xem cùng 1 lúc</span>
                  <span class="col-detail">4</span>
                </div>
                <hr>
                <div class="desc">
                  <span class="col">Số lượng thiết bị được tải xuống</span>
                  <span class="col-detail">5</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="main-container">
        <div class="content">
          ...
          <div class="yapping">
            ...
            <div class="slogan">An toàn để an tâm.</div>
            <div class="slogan">Hủy trực tuyến dễ dàng.</div>
          </div>
